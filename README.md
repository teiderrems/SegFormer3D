...
├── configs/                       # ⚙️ Configurations YAML commentées
...
├── architectures/                 # 🏗️ Code source des architectures (SegFormer3D)
...
**🚀 Prêt à segmenter !** Lancez `python pipeline.py --help` pour commencer.</content>
<parameter name="filePath">d:\data\documents\ING3_2025-2026\Projet_PIC\pic\SegFormer3D\README.md